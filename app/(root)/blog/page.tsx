    ...
    <main className="px-4 py-12 md:px-8 lg:px-20 font-bevietnam bg-white text-black-100">
      ...
      <section className="max-w-7xl mx-auto text-center mb-14">
        ...
        <p className="text-gray-600 text-sm md:text-base max-w-2xl mx-auto">
          Helpful tips, insights, and news from Optimum Quality Behavioral Health — your go-to source for professional advice.
        </p>
      </section>
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {posts.map((post) => (
          <div key={post._id?.toString()} className="border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition bg-white">
